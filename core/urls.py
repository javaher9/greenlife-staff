...
path('referrals/network/tree/<int:pk>/',referral_tree_views.referral_tree_person,name='referral_tree_person'),
...
path('lead/free/',referral_views.public_admin_qr_lead,name='public_admin_qr_lead'),path('beytoote/',referral_views.public_beytoote_lead,name='beytoote_public_lead'),path('aparat/',referral_views.public_aparat_lead,name='aparat_public_lead'),
...
path('shifts/',views.shift_list,name='shift_list'),path('shifts/today/',views.shift_today_bulk,name='shift_today_bulk'),path('shifts/new/',views.shift_create,name='shift_create'),path('shifts/assign/',views.shift_assign,name='shift_assign'),
...
path('login/',views.login_view,name='login'),path('logout/',views.logout_view,name='logout'),path('settings/catalog/',views.treatment_catalog_settings,name='treatment_catalog_settings'),path('settings/access/',views.credential_settings,name='credential_settings'),path('settings/api/',sms_views.api_server_settings,name='api_server_settings'),path('settings/access/<int:pk>/update/',views.credential_update,name='credential_update'),path('settings/access/<int:pk>/reveal/<str:kind>/',views.credential_reveal,name='credential_reveal'),path('settings/access/<int:pk>/view-as/',views.impersonate_start,name='impersonate_start'),path('settings/access/return/',views.impersonate_return,name='impersonate_return'),path('',views.dashboard,name='dashboard'),
