...
path('login/',views.login_view,name='login'),path('logout/',views.logout_view,name='logout'),path('settings/access/',views.credential_settings,name='credential_settings'),path('settings/access/<int:pk>/update/',views.credential_update,name='credential_update'),path('settings/access/<int:pk>/reveal/<str:kind>/',views.credential_reveal,name='credential_reveal'),path('settings/access/<int:pk>/view-as/',views.impersonate_start,name='impersonate_start'),path('settings/access/return/',views.impersonate_return,name='impersonate_return'),path('',views.dashboard,name='dashboard'),
