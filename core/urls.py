...
path('messages/',message_views.internal_messages,name='internal_messages'),path('messages/updates/',message_views.internal_message_updates,name='internal_message_updates'),
