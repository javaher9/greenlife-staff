...
path('lead/free/',referral_views.public_admin_qr_lead,name='public_admin_qr_lead'),path('beytoote/',referral_views.public_admin_qr_lead,name='beytoote_public_lead'),
