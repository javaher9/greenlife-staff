...
urlpatterns=[
    ...
    path('beytoote/banner/',instagram_views.beytoote_lead,{'campaign_type':'banner'},name='beytoote_banner_lead'),
    path('beytoote/reportage/',instagram_views.beytoote_lead,{'campaign_type':'reportage'},name='beytoote_reportage_lead'),
